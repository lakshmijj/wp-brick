			...
			<tbody>
				...
				<tr>
					...
					<td>
						...
						<input type="text" name="remoteTemplatesUrl" id="remoteTemplatesUrl" value="<?php echo isset( $settings['remoteTemplatesUrl'] ) ? esc_url( $settings['remoteTemplatesUrl'] ) : ''; ?>" placeholder="https://bricksbuilder.io" spellcheck="false" autocomplete="new-password">
