...
class Element_Posts extends Element {
	...
	public function render() {
		...
		// Do not render wrappers on infinite scroll request
		if ( bricks_is_builder_call() || ( $is_frontend && ! bricks_is_rest_call() ) ) {
		...
		// Do not render wrappers on an infinite scroll request
		if ( ! bricks_is_builder_call() || ( $is_frontend && ! bricks_is_rest_call() ) ) {
